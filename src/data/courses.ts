...
export const courses: Course[] = [
  ...
  {
    id: "google-partner-1600",
    title: "CX Agent Studio: Build Multimodal Customer Experience AI",
    description: "Official Google Partner Skills course on building multimodal customer experience agents with CX Agent Studio.",
    longDescription: "Google Partner Skills training for CX Agent Studio — learn to design, build, and deploy multimodal agents on Google Cloud.",
    url: "https://partner.skills.google/course_templates/1600",
    platform: "Google Partner Skills",
    image: "/placeholder.svg",
    modules: ["CX Agent Studio fundamentals", "Multimodal agent design", "Production deployment"],
    level: "Intermediate",
    duration: "Self-paced",
    featured: false,
  },
  {
    id: "google-partner-1446",
    title: "Google Conversational Agents Fundamentals",
    description: "Foundation course covering Google Cloud conversational AI and agent platform concepts.",
    longDescription: "Build foundational knowledge of Google's conversational AI stack before diving into CX Agent Studio.",
    url: "https://partner.skills.google/course_templates/1446",
    platform: "Google Partner Skills",
    image: "/placeholder.svg",
    modules: ["Conversational AI overview", "Dialogflow CX basics", "Agent platform concepts"],
    level: "Beginner",
    duration: "Self-paced",
    featured: false,
  },
  {
    id: "google-partner-1791",
    title: "Build Code-First Enterprise Agents with CX Agent Studio",
    description: "Advanced course on building enterprise-grade agents with code-first patterns and CX Agent Studio.",
    longDescription: "For developers who want to combine the visual builder with programmatic workflows, SCRAPI, and production CI/CD.",
    url: "https://partner.skills.google/course_templates/1791",
    platform: "Google Partner Skills",
    image: "/placeholder.svg",
    modules: ["Code-first agent patterns", "SCRAPI automation", "Enterprise deployment"],
    level: "Advanced",
    duration: "Self-paced",
    featured: false,
  },
